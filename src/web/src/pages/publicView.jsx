...
export default function PublicView(){
    ...
    return (
        <div className="w-screen h-screen bg-black-gradient flex flex-col justify-center items-center">
            ...
            <p className="text-3xl text-white font-black font-serif mt-5">
                Veja se seu pedido esta pronto
            </p>
            <div className="p-5 bg-orange-gradient rounded-2xl w-[50vw] my-20">
                {currentOrder ?
                        <div>
                            <h1 className="text-6xl text-white font-black text-center my-15">
                                Pedido Pronto
